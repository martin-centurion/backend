...
router.get('/carts/:cid', authenticationMiddleware('jwt'), authorizationMiddleware(['admin']), async (req, res, next) => {
...
router.post('/carts', authenticationMiddleware('jwt'), authorizationMiddleware(['admin']), async (req, res, next) => {
  try {
      const body = req.body;
